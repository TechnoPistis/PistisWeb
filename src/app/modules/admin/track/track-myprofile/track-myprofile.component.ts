...
@Component({
  selector: 'app-track-myprofile',
  templateUrl: './track-myprofile.component.html',
  styleUrls: ['./track-myprofile.component.css']
})
export class TrackMyprofileComponent implements OnInit {
...
this.Users=x as []
  ...
  debugger
  this.service.getCategories5().subscribe(x=>{
    debugger
    this.data=x as []
...
this.service.getFilterAccordingDate(newDate,"profile").subscribe((x:any)=>{
  debugger
  if(x.length==0)
