...
@Component({
  selector: 'app-track-compare',
  templateUrl: './track-compare.component.html',
  styleUrls: ['./track-compare.component.css']
})
export class TrackCompareComponent implements OnInit {
  Result:any
  Action:any
  address:any[]
  display = 'none';
...
this.Users=x as []
  ...
  debugger
  this.service.getCategories2().subscribe(x=>{
    debugger
    this.data=x as []
...
this.service.getFilterAccordingDate(newDate,"CompareProducts").subscribe(x=>{
  debugger
    this.sessions=x as []
});
