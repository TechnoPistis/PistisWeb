...
@Component({
  ...
  templateUrl: './footer.component.desktop.html',
  //styleUrls: ['./footer.component.css']
})
export class FooterFrontDesktopComponent  extends FooterFrontComponent {
  footer:[]
  ...
  constructor( toastr:ToastrService
    ...
    ) {super(toastr,Router,http,userLog,sanitizer,applicationStateService
      ,tracklog)}
  }