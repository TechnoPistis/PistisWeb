...
import { OptionsOnKeyValue } from 'highcharts';

@Component({
selector: "app-mycart-mobile",
templateUrl: "./mycart.component.mobile.html",
styleUrls: ["./mycart.component.css"]
})
export class MyCartMobileComponent extends MycartComponent implements OnInit{
