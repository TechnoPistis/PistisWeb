...
import { SideCategoryModel } from './deal';
...
export class DealService {
  ...
  getFilterProducts(filter,page,pagesize){
    return this.http.post<ProductCatalogue[]>(this.baseuri+'products/getFilterDealProducts?page='+page+"&pagesize="+pagesize,filter);
